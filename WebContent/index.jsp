...
<body>
	...
	<%  
		...
		if(request.getSession().getAttribute("topkFlag") != null){
			topkFlag =(Boolean)request.getSession().getAttribute("topkFlag"); 
		}
		if(request.getSession().getAttribute("pathConfFlag") != null){
			pathConfFlag = (Boolean)request.getSession().getAttribute("pathConfFlag");
		}
		if(request.getSession().getAttribute("installPathFlag") != null){
			installPathFlag = (Boolean)request.getSession().getAttribute("installPathFlag"); 
		}
	...
	<div class="container">
		...
		<ul class="nav navbar-nav">
			...
			<!-- <ul class="dropdown-menu">
					<%if(topkFlag){ %>
					<li class="disabled"><a href="javascript:void(0)">topk</a></li>
					<%}else{ %>
					<li><a href="RegisterTopkServlet?filename1=topk_query.py&filename2=topk_query_agg.py">topk</a></li>
					<%}
					if(pathConfFlag){
					%>
					<li class="disabled"><a href="javascript:void(0)">path conformance</a></li>
					<%}else{ %>
					<li><a href="RegisterPathconfServlet?filename=pathconf_check.py">path conformance</a></li>
					<%} %>
