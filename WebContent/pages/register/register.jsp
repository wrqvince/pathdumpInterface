...
<body>
	...
	<div class="container">
		<div class="row-fluid">
				...
				<form action="RegisterServlet" class="form-horizontal" role="form">
					<fieldset>
					...
					<fieldset>
						<legend>Choose Execute Pattern</legend>
						<div class="form-group">
							<label for="AggSelect" class="col-sm-2 control-label">Execute Pattern</label>
							<div class="col-sm-10">
